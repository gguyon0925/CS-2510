...
class Player {
  ...
  // helper method only used for the move method, helps readability of code and makes 
  // it more modular
...
// Represents the tests and examples for all the methods that create and run the maze
class ExamplesMaze {
  // represents the maze
  Maze maze;
  Maze mazeTest;
  ...
  void testQueueRemoveHead(Tester t) {
    ...
    t.checkException(new IllegalArgumentException("Queue is Empty"), queue, "removeHead");
  }
  ...
  void testStackRemoveHead(Tester t) {
    ...
    t.checkException(new IllegalArgumentException("No items in list."), stack, "removeHead");
  }
