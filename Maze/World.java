...
class Maze extends World {
  ...
  public Cell whichCell(Posn pos) {
    ...
    //System.out.println(x + " " + this.sizex + " " + y + " " + this.sizey);
    return null;
  }
  ...
  public WorldScene makeScene() {
    ...
    ArrayList<Cell> solutionPath = bfsSolution(); // or dfsSolution(this.cellCol.get(0).get(0), new ArrayList<>());
...
class ExamplesMaze {
  ...
  // uncomment this method start the game
  // void testStart(Tester t) {
  //     this.maze1.startGame(30, 10, true); // Set the third parameter to true to show the solution path
  // }
  ...
  // tests for the verticalEdge method
  ...
  //   initData();
  //   ArrayList<Cell> solutionPath = maze1.dfsSolution(maze1.cellCol.get(0).get(0), new ArrayList<>());
  //   t.checkExpect(solutionPath.get(0), maze1.cellCol.get(0).get(0));
  //   t.checkExpect(solutionPath.get(solutionPath.size() - 1), maze1.cellCol.get(9).get(9));
  //   }
